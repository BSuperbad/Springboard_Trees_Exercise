      ...
      while (toVisitStack.length){
        ...
        if (current && current.val !== null && current.val !== undefined) {
          if (current.val > lowerBound) {
            if(minGreater === null || current.val < minGreater) {
              minGreater = current.val;
            }
          }
  
          if(current.left && current.left.val > lowerBound){
              toVisitStack.push(current.left);
          }
          if(current.right && current.right.val > lowerBound){
